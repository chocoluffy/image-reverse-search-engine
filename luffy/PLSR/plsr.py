...
pls_pool5_to_BOW_all_pca_1024 = PLSRegression(n_components=600)
pls_pool5_to_BOW_all_pca_1024.fit(train_pool5_img[:8000], des_BOW_all_train_pca[:8000])
model_name = "./models/pls_600_pool5_to_BOW_all_pca_1024.pkl"
pickle.dump(pls_pool5_to_BOW_all_pca_1024, open(model_name, 'wb'), protocol=2)
print pls_pool5_to_BOW_all_pca_1024.score(train_pool5_img[8000:], des_BOW_all_train_pca[8000:])